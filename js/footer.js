  ...
  <div class="container mx-auto px-4 py-4">
    <div class="flex justify-between items-start gap-8">
      ...
      <div class="flex gap-12">
        ...
        <div class="space-y-2">
          <h3 class="text-base font-semibold text-foreground">Contact Us</h3>
          <div class="flex flex-col space-y-1">
            ...
            <p class="text-muted-foreground">Mon-Fri: 9:00 - 18:00</p>
            <p class="text-muted-foreground">Sat: 10:00 - 15:00</p>
          </div>
        </div>
        </div>
        <div class="space-y-2">
